...
class LabTestCreate(CoreModel):
    ...
    date: date = Field(..., description="Data de coleta ou realização.")
    ...
    status: LabTestStatus = Field(LabTestStatus.pending, description="Status: pending, completed ou abnormal.")
